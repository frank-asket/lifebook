...
export default function LivingWordDetail() {
  ...
  if (!teaching) {
    return <main className="living-detail missing-detail"><Link href="/">← Back to LifeBook</Link><h1>This teaching is not available.</h1></main>;
  }
  ...
  return (
    <main className="living-detail">
      <nav className="detail-nav page-shell"><Link className="detail-back" href="/#living-word">← LivingWord</Link><Link className="detail-wordmark" href="/"><span className="detail-mark">✦</span> LifeBook</Link><Link className="detail-home" href="/">Home ↗</Link></nav>
