  ...
  return (
    <div className="min-h-screen w-full bg-[#FAF8F5] flex flex-col lg:flex-row">
      ...
      <div className="lg:w-5/12 xl:w-5/12 bg-[#171421] text-white p-8 sm:p-12 lg:p-16 flex flex-col justify-between relative overflow-hidden border-b lg:border-b-0 lg:border-r border-[#2A233A]">
        ...
        />
        <div
          className="absolute -bottom-24 -right-24 w-96 h-96 rounded-full bg-[#1FB6B0] opacity-10 blur-3xl pointer-events-none"
          aria-hidden="true"
        />
        ...
        {/* Core Devotional Anchor & Scripture */}
      ...
      <div className="flex-1 flex flex-col justify-between p-6 sm:p-10 lg:p-16 bg-[#FAF8F5] overflow-y-auto">
        {/* Top Navigation */}
        <div className="flex items-center justify-between max-w-md w-full mx-auto mb-8">
        ...
        <div className="max-w-md w-full mx-auto my-auto py-4">
          <div className="mb-6">
            ...
            <p className="mt-2 text-sm text-[#706782] leading-relaxed">
              Sign in to your quiet place with God for daily scripture, prayer, and heart reflections.
            </p>
          </div>
        ...
        {/* Bottom Footer Links */}
        <div className="max-w-md w-full mx-auto mt-8 pt-4 flex items-center justify-between text-xs text-[#8A7E9F]">
