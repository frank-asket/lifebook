    ...
    <main className="showcase-page">
      ...
      <footer className="site-footer">
        <div className="page-shell">
          <div className="footer-lead"><a className="footer-banner" href="#top" aria-label="LifeBook home"><Image src="/lifebookbanner.png" alt="LifeBook" width={180} height={63} /></a><p>“Draw near to God, and he will draw near to you.”<small>James 4:8</small></p></div>
